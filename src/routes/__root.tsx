...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "N House Cutz — Master Barbershop in Las Vegas | Fades, Beards, Designs" },
      { name: "description", content: "N House Cutz is a top-rated barbershop on Rancho Dr in Las Vegas. Precision fades, beard sculpting and hair designs. 4.8 stars, 133 reviews. Book your chair." },
      { name: "author", content: "N House Cutz" },
      { name: "theme-color", content: "#ffffff" },
      { property: "og:title", content: "N House Cutz — Master Barbershop in Las Vegas | Fades, Beards, Designs" },
      { property: "og:description", content: "N House Cutz is a top-rated barbershop on Rancho Dr in Las Vegas. Precision fades, beard sculpting and hair designs. 4.8 stars, 133 reviews. Book your chair." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Playfair+Display:ital,wght@1,400;1,600&family=Inter:wght@300;400;500;600;700&display=swap" },
    ],
  }),
